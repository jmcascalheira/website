...
O texto para a 'Enciclopédia Digital de Teoria Arqueológica' deve ter **no máximo** 1000 palavras. Deverás seleccionar um arqueólogo ou tema no formulário disponibilizado **[AQUI]()**. As escolhas devem ser feitas até ao dia **5 de Março**. Se não fizeres a tua escolha até essa data ser-te-á designado aleatoriamente um arqueólogo/tópico dos restantes. Se escreveres sobre um tópico que não escolheste de antemão, o trabalho não será válido. Podes optar por escrever sobre um arqueólogo/tópico que não está na lista, mas precisas de confirmar com o docente com antecedência.
